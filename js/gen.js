...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function finalstep(){
        ...
        finaltexttitle.innerHTML = `You are about to View Photos of the <br> Instagram user: ${username}!`
        finaltext.innerText = `To continue with this process and View Photos of the user ${username}. You must complete Instagram Human Verfication step. After the verification is completed our server will resume to download and you can View Photos instantly.`
    ...
    confirmbtn.addEventListener( onclick="call_locker();" , () => {
        step3()
    })
});